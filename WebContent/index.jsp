...
<body>
	...
	<div class="container">
		...
		<i class="locaticon"></i>	<h3 style="float: left;">Select the Location</h3>
		...
		<div id="panel2" class="panel" style="">
			...
			<h3 style="width:120px;float:left;">
				<i></i>Select Your Resturant
			</h3>
              <b id="admin_text" style="float:right;padding:3px 5px;   box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.5);background: #e75854;" ><div class="filtericon"></div></b>
  <div id="settings" class="fa fa-cog"></div>
  <div id="menu">
    <div id="arrow"></div>
  <span class="filter"><input type="checkbox" name="" value="filter[]" id="group1"/><label for="group1">Main List</label></span> 
  <span class="filter"><input type="checkbox" name="" value="" id="group2"/><label for="group2">Main List</label></span>
    <span class="filter"><input type="checkbox" name="" value="" id="group3"/><label for="group3">Main List</label></span>
      <span class="filter"><input type="checkbox" name="" value="" id="group4"/><label for="group4">Main List</label></span>
  </div>
